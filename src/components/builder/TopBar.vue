<template>
  <div class="fixed top-0  w-full flex items-center justify-between bg-gray-900 h-12 px-5">
      <!-- Logo & Title -->
      <div class="flex items-center space-x-5">
        <div class="flex items-center justify-center bg-amber-600 rounded-full h-8 w-8">
